        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Song>().HasData(
                ...
                new Song()
                {
                    ...
                    Duration = "1:50",
                    AlbumId = 4,
                    AlbumTitle = "Satellite Flight: The Journey to Mother Moon"
                },
                new Song()
                {
                    Id = 52,
                ...
                new Song()
                {
                    ...
                    Duration = "4:29",
                    AlbumId = 6,
                    AlbumTitle = "Passion, Pain & Demon Slayin"
                },
                new Song()
                {
                    Id = 88,
