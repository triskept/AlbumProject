...
namespace AlbumProject.Migrations
{
    ...
    [Migration("20191030170630_FirstMigration")]
            ...
            modelBuilder.Entity("AlbumProject.Models.Album", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 18, ArtistId = 4, Image = "/images/elementoffreedom.jpg", Label = "J", Title = "The Element of Freedom" },
                        new { Id = 19, ArtistId = 4, Image = "/images/girlonfire.jpg", Label = "RCA", Title = "Girl on Fire" },
                        new { Id = 20, ArtistId = 4, Image = "/images/here.jpg", Label = "RCA", Title = "Here" }
                    );
                });
            ...
            modelBuilder.Entity("AlbumProject.Models.Artist", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 4, Age = 38, Hometown = "New York, New York", Image = "/images/alicia-keys.jpg", Name = "Alicia Keys" }
                    );
                });
